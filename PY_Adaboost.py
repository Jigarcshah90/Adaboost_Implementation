...
## The Below model main agenda is the implementation of Adaboost
...
## Now lets start implementing Adaboost
...
# From the above code we come to know best score 0.8239, best learning rate 0.1 and estimator = 100
...
# So we have 83% of accuracy after implementing Adaboost which is good. 
